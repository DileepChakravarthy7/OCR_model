# -*- coding: utf-8 -*-
"""HW_prediction_v4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fpsZETHhOKMKXe8s8vxz52Ql2SKX2dYn
"""
...
# it to reduce noise
image = cv2.imread("//content/drive/MyDrive/ocr_images/ROI_5.jpeg", cv2.IMREAD_COLOR)
...
for (pred, (x, y, w, h)) in zip(preds, boxes):
	...
	print("[INFO] {} - {:.2f}%".format(label, prob * 100))
	#cv2.rectangle(image, (x, y), (x + w, y + h), (0, 255, 0), 2)	
cv2.putText(image,str(convert(label_2)), (x-80, y+40),cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 0), 2)
# show the image

cv2_imshow(image)
cv2.waitKey(0)

print((convert(label_2))+(convert(label_1)))